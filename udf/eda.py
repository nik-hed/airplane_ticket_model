...
def price_change_plot(df,tripto,trip_limit):
    ...
    ax2 = ax1.twinx()
    ax2.plot(sorted_df['time_to_trip'], sorted_df['cumulative_sum'], color='red', marker='o', linestyle='-', label='Cumulative sum of change_status_num')
    ax2.set_ylabel('Cumulative sum of change_status_num')
